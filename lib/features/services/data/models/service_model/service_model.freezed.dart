...
abstract class $ServiceModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? status, bool? success, List<Service>? data});
}
...
class _$ServiceModelImpl implements _ServiceModel {
  _$ServiceModelImpl({this.status, this.success, final List<Service>? data})
      : _data = data;
  ...
  @override
  String toString() {
    return 'ServiceModel(status: $status, success: $success, data: $data)';
  }
...
abstract class _ServiceModel implements ServiceModel {
  factory _ServiceModel(
      {final int? status,
      final bool? success,
      final List<Service>? data}) = _$ServiceModelImpl;
